...
public class CrashHandler implements UncaughtExceptionHandler {
	...
	private String mErrorFilePath = "/BaseLY/";
	...
	private boolean handleException(Throwable ex) {
		...
		new Thread() {
			...
			public void run() {
				Looper.prepare();
				Toast.makeText(mContext,mContext.getString(R.string.error) , Toast.LENGTH_LONG)
						.show();
				Looper.loop();
			}
		}.start();
